        ...
        >
            ...
            {!data.collapsed && <div className="p-3 space-y-3 flex-1 flex flex-col overflow-y-auto">
                ...
                {(() => {
                    ...
                    return RegistryBody
                        ? <RegistryBody
                            type={type} id={id} data={data} inputs={inputs} result={result}
                            handleChange={handleChange} canEdit={canEdit}
                            moveKey={moveKey}
                            addFormField={addFormField} updateFormField={updateFormField} removeFormField={removeFormField}
                            formatInputDisplay={formatInputDisplay} formatResult={formatResult} onOpenEditor={onOpenEditor}
                        />
                        : null;
                })()}
